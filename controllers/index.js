    ...
    .then((results) => {
      mongo
        ...
        .then((video) => {
              ...
              exercises: [
                ...
                },
                {
                  ...
                  english: [
                    ...
                    {
                      text: "to toss and turn restlessly (in the bed)",
                      tag: "2",
                    },
                    { text: "vivid in one's mind (idiom)", tag: "3" },
                    {
                      text: "unconscious mind; subconscious mind; subconsciousness",
                      tag: "5",
                    },
                  ],
                },
                {
                  ...
                  answers: [
                    {
                      traditional:
                        "當你看著屏幕中一個個腥羴色，暴力的鏡頭，這些啊，其實都會進入你的潛意識。",
                      pinyin:
                        "dāng nǐ kàn zhe píngmù zhōng yīgègè xīng shān sè,bàolì de jìngtóu,zhèxiē a,qíshí dōu huì jìnrù nǐ de qiányìshí.",
                    },
                    {
                      traditional:
                        "刷劇這種行為其實不只是放鬆，有的時候也可能變成一種放縱哦",
                      pinyin:
                        "shuājù zhèzhǒng xíngwéi qíshí bù zhǐshì fàngsōng,yǒu de shíhou yě kěnéng biànchéng yīzhǒng fàngzòng o.",
                    },
                    {
                      traditional:
                        "當你看著屏幕中一個個腥羴色，暴力的鏡頭，這些啊，其實都會進入你的潛意識。",
          ...
          res.render("lesson.ejs", { data: data, results: results, video: video });
        })
        .catch((err) => {
          console.log(err);
        });
